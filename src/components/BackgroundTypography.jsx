...
const BackgroundTypography = () => {
  ...
  return (
    <div className="absolute top-1/2 left-0 -translate-y-[60%] w-max flex items-center z-0 pointer-events-none">
      <h1
        ref={textRef}
        className="text-[45vw] sm:text-[35vw] md:text-[25vw] font-display font-bold uppercase tracking-tighter text-black/5 whitespace-nowrap leading-none select-none pl-[10vw]"
      >
        ELECTRIC POWER
      </h1>
    </div>
